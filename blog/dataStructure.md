...
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure1.png)
...
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure2.png)
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure3.png)

    b. 完全二叉树：深度为k，有n个节点的二叉树，当且仅当其每一个节点都与深度为k的满二叉树中编号从1至n的节点一一对应时，称之为完全二叉树。  

![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure4.png)
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure5.png)
...
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure6.png)

WPL=3*4 + 5*4 + 7*4 + 8*4 + 11*3 + 14*3 + 23*2 + 29*2 = 271  

自己构造思路：从小到大排好序{3，5，7，8，11，14，23，29}，两两之和（红圈）与未构造数字（黑圈）比较，取小构造。  

![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure7.png)
...
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure8.png)


深度优先遍历：v1—>v2—>v4—>v8—>v5—>v3—>v6—>v7  

![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure9.png)


广度优先遍历：v1—>v2—>v3—>v4—>v5—>v6—>v7—>v8  

![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure10.png)
...
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure11.png)
![](http://plq1zlo1f.bkt.clouddn.com/docs-note/blog/data_structure12.png)
